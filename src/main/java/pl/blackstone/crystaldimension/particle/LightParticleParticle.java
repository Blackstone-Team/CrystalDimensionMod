...
package pl.blackstone.crystaldimension.particle;
...
public class LightParticleParticle extends CrystalDimensionModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(true);
	public LightParticleParticle(CrystalDimensionModElements instance) {
		super(instance, 3);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("light_particle"));
	}
