...
public class IceCrystalItem extends CrystalDimensionModElements.ModElement {
	@ObjectHolder("crystal_dimension:ice_crystal")
	public static final Item block = null;
	public IceCrystalItem(CrystalDimensionModElements instance) {
		super(instance, 23);
	}
