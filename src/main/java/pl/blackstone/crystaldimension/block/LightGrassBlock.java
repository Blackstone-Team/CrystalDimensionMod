...
public class LightGrassBlock extends CrystalDimensionModElements.ModElement {
	@ObjectHolder("crystal_dimension:light_grass")
	public static final Block block = null;
	public LightGrassBlock(CrystalDimensionModElements instance) {
		super(instance, 1);
	}
