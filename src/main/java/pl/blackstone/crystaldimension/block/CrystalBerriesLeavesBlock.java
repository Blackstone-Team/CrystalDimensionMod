...
import pl.blackstone.crystaldimension.procedures.CrystalBerriesLeavesBlockDestroyedByPlayerProcedure;
...
public class CrystalBerriesLeavesBlock extends CrystalDimensionModElements.ModElement {
	@ObjectHolder("crystal_dimension:crystal_berries_leaves")
	public static final Block block = null;
	public CrystalBerriesLeavesBlock(CrystalDimensionModElements instance) {
		super(instance, 34);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("crystal_berries_leaves");
		}
		...
		public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			int z = pos.getZ();
			{
				...
				CrystalBerriesLeavesBlockDestroyedByPlayerProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
